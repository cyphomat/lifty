...
export const MOVES = [
  { id:'thruster',  name:'Thruster',            kat:'hantel', reps:[6,12],  last:s=>auf25(s.squat.weight*0.45), cue:'Aus der Hocke durchziehen, keine Pause oben.',
    erklaerung:'Kniebeuge und Überkopfdrücken in einer Bewegung — deshalb geht der Puls schneller hoch als bei allem anderen mit der Stange. Der Trick ist, aus der Hocke durchzuziehen statt zweimal anzusetzen; wer oben stoppt, macht die doppelte Arbeit.',
  ...
  { id:'latzug',    name:'Latzug',              kat:'turnen', reps:[10,16], last:null, cue:'Ellbogen nach unten ziehen, nicht die Hände.',
    ...
    skalierung:['Leichter und dafür sauber','Enger Griff','Sitzendes Rudern am Kabel'] },
  { id:'pushup',    name:'Liegestütze',         kat:'turnen', reps:[10,20], last:null, cue:'Körper bleibt eine Linie.',
    erklaerung:'Horizontales Drücken mit Körpergewicht, quasi Bankdrücken ohne Bank. Der Rumpf arbeitet mit — sobald die Hüfte durchhängt, wird aus der Übung eine Rückenbelastung.',
  ...
  { id:'lunge',     name:'Ausfallschritte',     kat:'turnen', reps:[10,20], last:null, cue:'Knie kontrolliert absetzen.',
    erklaerung:'Einbeinige Kniebeuge im Gehen. Deckt genau das ab, was die beidbeinige Kniebeuge auslässt: seitliche Stabilität und Unterschiede zwischen links und rechts.',
